        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clientes_Profesionales_ProfesionalID",
            ...
            migrationBuilder.CreateTable(
                name: "MaximasRepeticiones",
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Repeticion = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaximasRepeticiones", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MaximasRepeticiones_Clientes_ClienteID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_ProfesionalID",
                table: "Clientes",
                column: "ProfesionalID");

            migrationBuilder.CreateIndex(
                name: "IX_MaximasRepeticiones_ClienteID",
